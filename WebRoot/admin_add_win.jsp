						...
						<div class="span3">
							...
							<div class="span9">
								<div class="page-header">
									<h3>
										为该用户添加获奖信息<small>请按照提示填写</small>
									</h3>
								</div>
								<form class="form-horizontal" action="/Ice_Hockey/PublishWin" method="post" enctype="multipart/form-data" name="form1">
